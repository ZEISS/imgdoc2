# Introduction
Thank you for considering contributing to imgdoc2.  

Following these guidelines helps to communicate that you respect the time of the developers managing and developing this open source project. In return, they should reciprocate that respect in addressing your issue, assessing changes, and helping you finalize your pull requests.  

imgdoc2 is an open source project and we love to receive contributions from our community — you! There are many ways to contribute, from writing tutorials or blog posts, improving the documentation, submitting bug reports and feature requests or writing code which can be incorporated into imgdoc2 itself.  

No matter how you intend to participate in improving imgdoc2 - please make sure to follow our [Code of Conduct](./CODE_OF_CONDUCT.md).
...
If you find yourself wishing for a feature or improvement that doesn't exist/isn't planned in imgdoc2, you are probably not alone. There are bound to be others out there with similar needs. Open an issue on our issues list on GitHub which describes the feature you would like to see, why you need it, and how it should work.
